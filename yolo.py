...
class YOLO(object):
    ...
    def __init__(self, **kwargs):
        ...
        # Might be bugs in this code? args don't match the class attr names
        self.model_path = kwargs.get('model', self.model_path)
        self.anchors_path = kwargs.get('anchors', self.anchors_path)
